...
let randomQuotes = () =>{
    ...
    let random = allQuotes[randomNumber];
    return random;
    console.log(random)
}
 ...
 let generateQuotes = () =>{
    let quote1 = randomQuotes();
    //console.log(quote1)
    
    let value = Object.values(quote1);
    let quoteText = value[0];
    let quoteSource = value[1];

    document.getElementById("p").innerHTML = quoteText;
    document.getElementById("sorc").innerHTML = quoteSource;
